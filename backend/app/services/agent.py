...
SYSTEM_INSTRUCTION = (
    ...
    "algorithm:\n\n"
    "SEARCH RULE: NEVER stop after viewing just 2-3 files or fragments. If "
    "you don't find what you need in the first few results, CONTINUE searching "
    "across all relevant documents, directories, and sources. 'Not found' is "
    "ONLY acceptable after you have exhaustively checked all relevant locations "
    "and are confident the information truly does not exist.\n\n"
    "ALGORITHM:\n"
    ...
    "then part 3. Never try to find everything in one search.\n"
    ...
    "understand the content and complete the task thoroughly.\n\n"
